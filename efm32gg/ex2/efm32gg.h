...
#define TIMER1_IF   ((volatile uint32_t*)(TIMER1_BASE + 0x010))
...
#define TIMER2_IF   ((volatile uint32_t*)(TIMER2_BASE + 0x010))
...
#define DAC0_CTRL     ((volatile uint32_t*)(DAC0_BASE + 0x000))
#define DAC0_CH0CTRL  ((volatile uint32_t*)(DAC0_BASE + 0x008))
#define DAC0_CH1CTRL  ((volatile uint32_t*)(DAC0_BASE + 0x00c))
#define DAC0_IEN      ((volatile uint32_t*)(DAC0_BASE + 0x010))
#define DAC0_IF       ((volatile uint32_t*)(DAC0_BASE + 0x014))
#define DAC0_IFS      ((volatile uint32_t*)(DAC0_BASE + 0x018))
#define DAC0_IFC      ((volatile uint32_t*)(DAC0_BASE + 0x01c))
#define DAC0_CH0DATA  ((volatile uint32_t*)(DAC0_BASE + 0x020))
#define DAC0_CH1DATA  ((volatile uint32_t*)(DAC0_BASE + 0x024))
#define DAC0_COMBDATA ((volatile uint32_t*)(DAC0_BASE + 0x028))
